      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5">
            <img src="<?=base_url('assets/assets_user/')?>images/person_1.jpg" alt="Free website template by Free-Template.co" class="img-fluid mb-3">
            <h3 class="h4">Susan Horton</h3>
            <p class="caption text-primary">Founder</p>
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
          </div>
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5 mt-md-5">
            <img src="<?=base_url('assets/assets_user/')?>images/person_2.jpg" alt="Free website template by Free-Template.co" class="img-fluid mb-3">
            <h3 class="h4">Jonathan Kennedy</h3>
            <p class="caption text-primary">Founder</p>
            <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
          </div>
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5">
            <img src="<?=base_url('assets/assets_user/')?>images/person_3.jpg" alt="Free website template by Free-Template.co" class="img-fluid mb-3">
            <h3 class="h4">Gordon Meyer</h3>
            <p class="caption text-primary">Lead Developer</p>
          </div>
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-5 mt-md-5">
            <img src="<?=base_url('assets/assets_user/')?>images/person_4.jpg" alt="Free website template by Free-Template.co" class="img-fluid mb-3">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            ...
            <p class="color-black-opacity-5">People also ask us..</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 mr-auto mb-4 mb-lg-0">
            <h2 class="mb-3 mt-0 text-white">Create Account To Use Offers.</h2>

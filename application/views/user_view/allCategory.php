          ...
          <div class="col-md-10">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-10 text-center">
                <!-- search for text  -->
                <h1 data-aos="fade-up">All Category</h1>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            ...
            <p class="color-black-opacity-5">There are all categories which are very popular in this days.</p>
          </div>
        </div>
          ...
          foreach($result as $r){ 
            ...
            ?>
              <div class="col-6 col-sm-6 col-md-4 mb-4 mb-lg-3 col-lg-2">
                <a href="<?=base_url('findSubcategory/').$r['CategoryId']?>" data-id="<?=$r['CategoryId']?>" class="category-class popular-category h-100">

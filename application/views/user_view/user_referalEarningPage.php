          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                ...
                <p> Dear Customer, Please enter the Referal Code of your friends.  </p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 mb-5"  data-aos="fade">
            <form action="<?=base_url('referAndEarn')?>" method="post" class="p-5 bg-white" style="margin-top: -150px;">
              <div class="row form-group">
                <div class="col-md-12 mb-12 mb-md-0">
                  <label class="text-black" for="email">Enter Raferal Code</label>
                  <input type="text" name="RaferalCode" id="RaferalCode" placeholder="Enter Raferal Code Of Friends" class="form-control">
                </div>
                <!-- <div class="col-md-6">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <button class="btn btn-primary btn-md text-white"><a class="text-white" href="<?=base_url('user/uc_login_page')?>"> Don't Have Referal Code </a></button>
                </div>
              </div>

          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                ...
                <p> Dear Customer, Please enter the email so we can send you link  </p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 mb-5"  data-aos="fade">
            <form action="<?=base_url('sendForgotPasswordLink')?>" method="post" class="p-5 bg-white" style="margin-top: -150px;">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Send Link" class="btn btn-primary btn-md text-white">
                </div>
              </div>

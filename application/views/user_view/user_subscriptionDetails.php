    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          ...
          <?php
              foreach ($subscriptionDetails as $log) {
                // print_r($log);
            ...
            <div class="col-xl-12 mb-2">
              <div class="row">
                <div class="col-xl-1 col-sm-2">
                  <img style="width: 75px; height: 75px; margin-top: 10px;" src="<?=base_url('assets/assets_business_images/').$businessDetails[0]['BusinessImage']?>" >
                </div>
                <a href="<?=base_url('user/allOffersOfBusiness/').$businessDetails[0]['BusinessId']?>" class="col-xl-2 col-sm-2">
                  <b> <?=$businessDetails[0]['CompanyName']?> </b>
                </a>
                ...
                <div class="col-xl-2 col-sm-2">
                  <br>
                  <?=$businessDetails[0]['BusinessPhone']?>
                </div>
                <div class="col-xl-3 col-sm-2">
                  ...
                  <?php }else{?>
                    <a href="<?=base_url('user/unSubscribeBusiness1/').$log['BusinessId']?>"> <button style="background: #333!important;" class="btn btn-pink"> Subscribed </button> </a>
                  <?php } ?>
                </div>
            </div>
            </div>

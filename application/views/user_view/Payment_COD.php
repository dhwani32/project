...
$PAYU_BASE_URL = base_url('payment/paymentCOD');
$action = '';
...
$hash = '';
// Hash Sequence
$hashSequence = "txnid|amount|productinfo|firstname|email|udf1|udf2|udf3|udf4|udf5|udf6|udf7|udf8|udf9|udf10";
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                <div class="text-center custom-login">
                    <h3>Payment Using Wallet</h3>
                    <p>Safe Transaction from your wallet</p>
                </div>
                <div class="hpanel">

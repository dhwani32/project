...
<body>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"><a href="<?=base_url('admin/manageCity');?>" >Manage City</a></li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">City Table 
                            <button class="offset-8 col-2 btn btn-purple"  data-toggle="modal" data-target="#AddCityModal">Add City</button></h5>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="AddCityModalTitle">Add City</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form enctype="multipart/form-data" action="<?=base_url('admin/addCity');?>" method="post">
            <div class="modal-body">
             ...
             <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-primary" name="AddCityButton" value="Add City">
            </div>
          </form>
        </div>
      </div>
    ...
    <div class="modal fade" id="editCityModel" tabindex="-1" role="dialog" aria-labelledby="editCityModelTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="editCityModelTitle">Edit City</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form enctype="multipart/form-data" action="<?=base_url('admin/editCity');?>" method="post">
            <div class="modal-body">
                <label>City Id</label>
                <input type="text" name="CityId1" id="CityId1" value="" readonly class="form-control">
                <label>Enter City Name</label>
                <input type="text" name="CityName1" id="CityName1" value="" class="form-control" required>
               
             </div>
             <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <input type="submit" class="btn btn-primary" name="AddCityButton" value="Edit City">
            </div>
          </form>
        </div>
      </div>
...
<script type="text/javascript">
    ...
    $('#StateDropDown').click(function(){
        ...
        $.ajax({
            url:'<?=base_url('admin/getCityTable/')?>'+cid,
            success:function(result){
                $('#CityTable').html(result);
            }
        });
    });

     $(document).on("click", ".open-EditCategoryModel", function () {
        var CityId1 = $(this).data('id');
        var CityName1 = $(this).data('name');

        $(".modal-body #CityId1").val(CityId1);
        $(".modal-body #CityName1").val(CityName1);

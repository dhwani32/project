                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo $action; ?>" method="post" name="payuForm">
                          ...
                          <div class="col-md-12">
                            <label>Amount : </label>
                            <input readonly class="form-control" name="amount" value="<?php echo (empty($posted['amount'])) ? $sponsorPlanDetails[0]['PlanPrice'] : $posted['amount'] ?>" />
                          </div>
                          ...
                          <div class="col-md-12">
                            ...
                            <input type="text" readonly class="form-control" name="productinfo" value="<?php echo (empty($posted['productinfo'])) ? $sponsorPlanDetails[0]['PlanName'] : $posted['productinfo'] ?>" >
                          </div>

                          <input type="hidden" name="surl" value="<?=base_url('business/sponsorPlanPayment_success/')?><?=$businessDetails[0]['BusinessId']?>/<?=$userId?>/<?=$sponsorPlanDetails[0]['SponsorPlanId']?>" size="64" />

                          <input type="hidden" name="furl" value="<?=base_url('business/SponsorPlanPayment_fail')?>" size="64" />
